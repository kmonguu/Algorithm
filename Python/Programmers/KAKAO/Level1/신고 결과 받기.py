...
# 따라서 "muzi"는 처리 결과 메일을 2회, "frodo"와 "apeach"는 각각 처리 결과 메일을 1회 받게 된다.

# 이용자의 ID가 담긴 문자열 배열 id_list, 
# 각 이용자가 신고한 이용자의 ID 정보가 담긴 문자열 배열 report, 
# 정지 기준이 되는 신고 횟수 k가 매개변수로 주어질 때, 각 유저별로 처리 결과 메일을 받은 횟수를 배열에 담아 반환한다.

# 인터넷을 참고하여 푼 코드
# collections모듈의 defaultdict을 활용하여 
# 신고자의 id와 신고 대상이 받은 신고 횟수를 저장하기 위해 user, report_count를 딕셔너리로 선언하였다.
